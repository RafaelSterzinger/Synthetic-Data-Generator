...
plt.figure(figsize=(7, 4))
plt.plot([i + 1 for i in range(n_epochs)], history.history['val_acc'], '-o', c='k', lw=2, markersize=9)
plt.grid(True)
...
plt.figure(figsize=(7, 4))
plt.plot([i + 1 for i in range(n_epochs)], history.history['val_loss'], '-o', c='k', lw=2, markersize=9)
plt.grid(True)
